...
func (b *BucketHandle) AddNotification(ctx context.Context, n *Notification) (ret *Notification, err error) {
	ctx = trace.StartSpan(ctx, "github.com/smyte/google-cloud-go/storage.Bucket.AddNotification")
...
func (b *BucketHandle) Notifications(ctx context.Context) (n map[string]*Notification, err error) {
	ctx = trace.StartSpan(ctx, "github.com/smyte/google-cloud-go/storage.Bucket.Notifications")
	defer func() { trace.EndSpan(ctx, err) }()
...
func (b *BucketHandle) DeleteNotification(ctx context.Context, id string) (err error) {
	ctx = trace.StartSpan(ctx, "github.com/smyte/google-cloud-go/storage.Bucket.DeleteNotification")
	defer func() { trace.EndSpan(ctx, err) }()
