...
func (a *ACLHandle) Delete(ctx context.Context, entity ACLEntity) (err error) {
	ctx = trace.StartSpan(ctx, "github.com/smyte/google-cloud-go/go/storage.ACL.Delete")
...
func (a *ACLHandle) Set(ctx context.Context, entity ACLEntity, role ACLRole) (err error) {
	ctx = trace.StartSpan(ctx, "github.com/smyte/google-cloud-go/go/storage.ACL.Set")
	defer func() { trace.EndSpan(ctx, err) }()
...
func (a *ACLHandle) List(ctx context.Context) (rules []ACLRule, err error) {
	ctx = trace.StartSpan(ctx, "github.com/smyte/google-cloud-go/go/storage.ACL.List")
	defer func() { trace.EndSpan(ctx, err) }()
