...
func (c *Client) JobFromIDLocation(ctx context.Context, id, location string) (j *Job, err error) {
	ctx = trace.StartSpan(ctx, "github.com/smyte/google-cloud-go/bigquery.JobFromIDLocation")
...
func (j *Job) Status(ctx context.Context) (js *JobStatus, err error) {
	ctx = trace.StartSpan(ctx, "github.com/smyte/google-cloud-go/bigquery.Job.Status")
	defer func() { trace.EndSpan(ctx, err) }()
...
func (j *Job) Wait(ctx context.Context) (js *JobStatus, err error) {
	ctx = trace.StartSpan(ctx, "github.com/smyte/google-cloud-go/bigquery.Job.Wait")
	defer func() { trace.EndSpan(ctx, err) }()
...
func (j *Job) Read(ctx context.Context) (ri *RowIterator, err error) {
	ctx = trace.StartSpan(ctx, "github.com/smyte/google-cloud-go/bigquery.Job.Read")
	defer func() { trace.EndSpan(ctx, err) }()
